...
B_0	EQU 0	; Empty code (if used on Overflow Patterns, means TODO/UNKNOWN)
B_R	EQU	1	; r = red
B_G	EQU	2	; g = green
B_B	EQU	3	; b = blue
B_Y	EQU	4	; y = yellow
...
BOARD_OVERFLOW_PATTERN_BLACK_PIERROT
	DEFB		B_W,	B_B,	B_G,	B_W,	B_Y,	B_R,	B_W
	DEFB		B_B,	B_W,	B_Y,	B_R,	B_G,	B_W,	B_R
	DEFB		B_R,	B_G,	B_W,	B_B,	B_W,	B_Y,	B_B
	DEFB		B_Y,	B_W,	B_B,	B_Y,	B_G,	B_W,	B_R
...
BOARD_OVERFLOW_PATTERN_TAB
	DEFW	BOARD_OVERFLOW_PATTERN_DEVIL
	DEFW	BOARD_OVERFLOW_PATTERN_FOOL
	DEFW	BOARD_OVERFLOW_PATTERN_STAR
	DEFW	BOARD_OVERFLOW_PATTERN_CHARIOT
	DEFW	BOARD_OVERFLOW_PATTERN_PRIESTESS
	DEFW	BOARD_OVERFLOW_PATTERN_JUSTICE
	DEFW	BOARD_OVERFLOW_PATTERN_MAGICIAN
	DEFW	BOARD_OVERFLOW_PATTERN_WORLD
	DEFW	BOARD_OVERFLOW_PATTERN_STRENGTH
	DEFW	BOARD_OVERFLOW_PATTERN_EMPRESS
	DEFW	BOARD_OVERFLOW_PATTERN_BLACK_PIERROT
